...
function MyComponent() {
    ...
    return (
        <div className="bg-white min-h-screen">
            ...
            <header className="flex text-black ml-5 justify-start text-2xl font-bold pt-5 px-5 mb-4">STAFF PROFILE- PHARMACIST</header>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 justify-end">
                    ...
                    <div style={{ borderRadius: '25px' }} className=" lg:col-span-3 bg-white p-4 rounded-lg mb-5 lg:mb-10 mx-5">
                        <div className="flex justify-between gap-4" >
                            <h3 className=' flex text-xl text-slate-800 font-bold justify-start mb-4'>Pharmacist Information</h3>
                                    ...
                                    <table className="min-w-full text-sm lg:text-xl italic bg-white">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td className=" whitespace-nowrap text-gray-500">:</td>
                                                <td className="lg:pl-4  whitespace-nowrap text-gray-500">{formData.password}</td>
                                            </tr>
