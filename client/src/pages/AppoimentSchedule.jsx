            ...
            <div>
                ...
                <div className='w-full bg-white  px-5 pt-3'>
                    <form style={{ backgroundColor: '#C8EAF3', borderRadius: '25px' }} onSubmit={handleSubmit} className="flex mt-16 mx-10 flex-col p-10 space-y-4">
                        ...
                        <h1 className="text-xl text-slate-900 font-normal mb-2">Schedule new appointment here </h1>
                        <div className=' '>
                        ...
                        <div className="flex pt-24 justify-end">
                            <Button
                                type="submit"
                                className="bg-blue-700 justify-center text-white  rounded hover:bg-blue-600 focus:outline-none focus:bg-blue-600"
                            >
                                ADD APPOIMENT
                            </Button>
                        </div>
