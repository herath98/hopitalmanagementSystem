            ...
            <div>
                ...
                <div className='pt-10'>
                    <div style={{ borderRadius: '25px' }} className='bg-blue-100 mx-8 mt-10 px-4 '>
                        <h2 className="flex justify-start text-xl px-2 md:px-5 lg:px-10 pt-5 text-slate-800 mt-5 mb-4">Enroll your Staff Member here</h2>
                    <form onSubmit={handleSubmit}>
                    <div className="px-5 pb-5 lg:px-10 grid grid-col-1 lg:grid-cols-3  gap-4">
                    ...
                    <div className="px-5 lg:px-10 grid grid-col-1 lg:grid-cols-3 gap-4">
                        <div>
                    ...
                    <div className="px-5 mt-5 pb-5 lg:px-10 grid grid-col-1 lg:grid-cols-3  gap-4">
                        <div>
                    ...
                    <div className='flex mx-4 mt-4 mb-10 justify-end px-5 pb-10'>
                        <button className='text-white px-4 bg-indigo-600 py-2 rounded ' type="submit">ENROLL</button>
                    </div>
                </form>
                </div>
            </div>
