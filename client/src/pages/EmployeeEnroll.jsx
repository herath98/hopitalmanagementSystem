            ...
            <div>
                ...
                <div className='pt-10'>
                    <div style={{ borderRadius: '25px' }} className='bg-blue-100 mx-8 mt-10 px-4 '>
                        <h2 className="flex justify-start text-md px-2 md:px-5 lg:px-10 pt-5 text-slate-800 mt-5 mb-4">Enroll your Staff  <span className='font-bold px-1'>{formData.firstName}</span> Member here</h2>
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className='flex mx-4 mt-4 mb-10 justify-end px-5 pb-10'>
                                <button className='px-5 py-2 rounded bg-indigo-600 text-white' type="submit">ENROLL</button>
                            </div>
                        </form>
                </div>
            </div>
