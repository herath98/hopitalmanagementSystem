        ...
        <form className="lg:px-20" onSubmit={handleSubmit}>
              ...
              <div className="">
                <div style={{borderRadius:'15px'}} className="w-full  mt-8">
                  <TextInput style={{borderRadius:'15px'}} id="email" name="email" type="email" placeholder="Email" onChange={handleChange} />
                </div>
                <div className="w-full mt-8">
                  <TextInput style={{borderRadius:'15px'}} id="password" name="password" type="password" placeholder="Password" onChange={handleChange} />
                </div>
                <div className="justify-end flex ">
                  {/* Call handleOpenPasswordReset when the link is clicked */}
                  <p style={{}} className="text-sm mt-4 cursor-pointer text-slate-950 italic font-bold " onClick={handleOpenPasswordReset}>FORGOT PASSWORD?</p>
                </div>
